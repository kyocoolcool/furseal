...
export class SalaryListComponent implements OnInit {
   ...
   */
  constructor(private salaryListService: SalaryListService, private _coreTranslationService: CoreTranslationService, private route: ActivatedRoute,
  ...
  ngOnInit() {
    ...
    this.salaryListService.onDatatablessChanged.pipe(takeUntil(this._unsubscribeAll)).subscribe(response => {
      this.rows = response;
  ...
  onDateSelection(date: NgbDate) {
    ...
    if (this.fromDate != null && this.toDate != null) {
      this.salaryListService.querySalary(this.fromDate, this.toDate);
    }
