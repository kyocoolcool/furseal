...
public interface BillRepository extends JpaRepository<Bill, Long> {
    ...
    @Query(value = "select b.bill_id as billId,gm.name as gainer,bum.name as buyer ,b.money,b.way,b.status,b.gain_time as gainTime,b.transaction_time as transactionTime,p.name, count(bm.bill_id) as count\n" +
            ...
            "    left join members bum on b.buyer=bum.member_id where b.deleted=:deleted \n" +
